...
const Sidebar = () => {
  const styles = {
    container: `h-auto w-[300px] flex flex-col bg-gradient-to-r from-[#4b79a1] to-[#283e51] static`,
    profile: ` w-full py-16 flex flex-col justify-center items-center rounded-3xl bg-gradient-to-t from-[#000000] to-[#434343] mt-[40px] mb-[50px] border-2 border-[#fb9701]`,
