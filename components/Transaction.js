...
const Transaction = ({ item }) => {
  const styles = {
    container: ` w-[40%] flex flex-col border-[#d6d7d9] border-2 rounded-xl shadow-lg bg-[#F0EBE3]`,
    top: `flex w-full h-[80px] bg-[#000000] p-[20px] pr-[80px] gap-[80px] rounded-xl rounded-b-none`,
    topHeaderText: `text lg text-left flex items-center text-[#fff]`,
